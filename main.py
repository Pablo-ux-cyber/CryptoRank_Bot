    ...
    try:
        ...
        annotations.extend([
            ...
            },
            {
                'x': 0.5, 'y': 10,
                'xref': 'paper', 'yref': 'y2',
                'text': '<b>📊 Как читать график:</b><br>• <b>Высокие значения (80%+):</b> Большинство монет растут → Рынок может быть перегрет<br>• <b>Средние значения (20-80%):</b> Обычные рыночные условия<br>• <b>Низкие значения (до 20%):</b> Большинство монет падают → Возможность покупки',
                'showarrow': False,
                'xanchor': 'center',
                'yanchor': 'bottom',
