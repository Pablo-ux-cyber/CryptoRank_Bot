...
class GoogleTrendsPulse:
    def __init__(self):
        ...
        """
        # Создаем подключение с увеличенными таймаутами и настройками для предотвращения ошибок 429
        self.pytrends = TrendReq(
            hl='en-US', 
            tz=360,
            timeout=(10, 25),  # Увеличенный таймаут для подключения и чтения
            retries=3,  # Количество повторных попыток при ошибках
            backoff_factor=1.5  # Множитель для увеличения паузы между повторными попытками
        )
